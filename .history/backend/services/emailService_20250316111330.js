  ...
  async sendVerificationEmail(user, verificationToken) {
    ...
    const mailOptions = {
      ...
      html: `
        ...
        <p>Xin chào ${user.username},</p>
        <p>Cảm ơn bạn đã đăng ký tài khoản tại MangaCorner. Vui lòng click vào đường dẫn bên dưới để xác nhận email của bạn:</p>
        <a href="${verificationURL}" style="display: inline-block; padding: 10px 20px; color: white; background-color: #4CAF50; text-decoration: none; border-radius: 5px;">Xác nhận tài khoản</a>
