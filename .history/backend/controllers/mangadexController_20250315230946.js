...
exports.searchManga = async (req, res) => {
  ...
  try {
    const { limit = 24, offset = 0, sort = 'latestUploadedChapter', order = 'desc', language = 'vi' } = req.query;
    
    // Tạo đối tượng orderParams phù hợp với API MangaDex
    const orderParams = {};
    orderParams[sort] = order;
    ...
    const response = await axios.get(url, {
      params: {
        ...
        // Chuyển order thành chuỗi JSON thay vì object
