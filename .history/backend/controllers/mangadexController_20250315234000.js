...
exports.getMangaChapters = async (req, res) => {
  try {
    ...
    params.limit = parseInt(limit);
    params.offset = parseInt(offset);
    params['translatedLanguage[]'] = [language, 'en']; // Lấy cả tiếng Việt và tiếng Anh
    params['order[chapter]'] = 'desc';
    params['includes[]'] = ['scanlation_group'];
    
    console.log(`Gọi API MangaDex chapters cho manga ${mangaId} với params:`, JSON.stringify(params));
