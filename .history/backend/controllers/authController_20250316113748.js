  ...
  signup: catchAsync(async (req, res, next) => {
    ...
    try {
      ...
      try {
        ...
        // Vẫn trả về thành công nhưng với cảnh báo
        res.status(201).json({
          status: 'success',
          message: 'Đăng ký thành công! Tuy nhiên, không thể gửi email xác nhận.',
          warning: 'Hệ thống không thể gửi email xác nhận. Vui lòng liên hệ quản trị viên.',
          // Trong môi trường phát triển, trả về OTP để thuận tiện kiểm tra
          ...(process.env.NODE_ENV === 'development' && { otp })
        });
      }
