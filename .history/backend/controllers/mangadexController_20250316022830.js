...
exports.getMangaChapters = async (req, res) => {
  try {
    ...
    // Log để debug
    console.log('Đang xử lý request cho mangaId:', mangaId);
    
    const params = {
      limit: parseInt(req.query.limit) || 100,
      offset: parseInt(req.query.offset) || 0,
      translatedLanguage: req.query.translatedLanguage || ['vi', 'en'],
      order: { chapter: 'desc' },
      includes: ['scanlation_group']
    };
    
    console.log('Params for MangaDex API:', params);
    ...
    console.log('MangaDex API response data length:', response.data?.data?.length);
    ...
    console.error('Error in getMangaChapters:', error.message);
