...
// import defaultAvatar from '../assets/images/default-avatar.png'; // Tạo file ảnh này

// Định nghĩa defaultAvatar ngay trong component
                ...
                <Menu.Button className="flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500">
                  ...
                  <div className="w-8 h-8 rounded-full overflow-hidden bg-purple-700">
                    <img 
                      ...
                      onError={(e) => {
                        // Sử dụng văn bản thay vì hình ảnh nếu lỗi
