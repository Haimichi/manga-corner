...
const Header = () => {
  ...
  return (
    <nav className="bg-purple-900 sticky top-0 z-50 shadow-lg">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Menu as="div" className="relative">
              <Menu.Button className="text-white hover:text-pink-200 px-3 py-2 text-sm font-medium uppercase flex items-center">
                Bảng xếp hạng
              </Menu.Button>
              <Transition
                as={Fragment}
            ...
            <div>
              <form onSubmit={handleSearch} className="relative">
                <input
                  ...
                  className="bg-purple-800 text-white w-48 px-4 py-2 rounded-full focus:outline-none focus:ring-2 focus:ring-white text-sm"
                  value={searchTerm}
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 border-t border-purple-800">
            ...
            <form onSubmit={handleSearch} className="relative mt-3">
              <input
                type="text"
                placeholder="Tìm kiếm truyện..."
                className="bg-purple-800 text-white w-full px-4 py-2 rounded-full focus:outline-none focus:ring-2 focus:ring-white"
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
              />
              <button
