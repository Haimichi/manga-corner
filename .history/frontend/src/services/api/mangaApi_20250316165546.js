...
const mangaApi = {
  ...
  getLatest: async (params = {}) => {
    ...
    try {
      console.log('Đang gọi API lấy manga mới nhất với params:', params);
      ...
      console.error('Lỗi khi gọi API lấy manga mới nhất:', error);
      throw error;
    }
  },
  ...
  getPopular: async (params = {}) => {
    try {
      console.log('Đang gọi API lấy manga phổ biến với params:', params);
      ...
      console.error('Lỗi khi gọi API lấy manga phổ biến:', error);
      throw error;
    }
  },
