...
const Home = () => {
  ...
  // Thêm định nghĩa featuredGenres vào đây
  ...
  const renderCarousel = () => {
    if (loading || !hasPopularManga) {
      return (
        <div className="bg-gradient-to-r from-gray-700 to-gray-900 relative h-80 rounded-lg overflow-hidden animate-pulse">
    ...
    return (
      <div className="relative h-96 md:h-[450px] rounded-lg overflow-hidden shadow-xl">
              ...
              <div className="container mx-auto px-6 md:px-10 flex items-center">
                <div className="w-full md:w-2/3 text-white">
                  <Link to={`/manga/${manga.id}`}>
                    <h2 className="text-3xl md:text-4xl font-bold mb-3 hover:text-blue-400 transition">
                      {getTitle(manga)}
                    </h2>
                  </Link>
                  ...
                  <Link 
                    to={`/manga/${manga.id}`}
                    className="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md inline-flex items-center transition"
                  >
                    Xem chi tiết
        ...
        <button 
          ...
          className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-black bg-opacity-30 text-white flex items-center justify-center hover:bg-opacity-50 focus:outline-none z-20"
        >
        ...
        <button 
          ...
          className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-black bg-opacity-30 text-white flex items-center justify-center hover:bg-opacity-50 focus:outline-none z-20"
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="container mx-auto py-6 px-4">
        ...
        {/* Thể loại nổi bật */}
        <div className="mt-12">
          <h2 className="text-xl font-bold mb-6 text-gray-800 dark:text-gray-200">Thể loại nổi bật</h2>
