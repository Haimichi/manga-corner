...
const Home = () => {
  ...
  const getHighResolutionCover = (manga) => {
    try {
      ...
      // Sử dụng URL gốc thay vì URL có kích thước cố định
  ...
  const renderCarousel = () => {
    if (loading || !hasPopularManga) {
      return (
        <div className="bg-gradient-to-r from-gray-700 to-gray-900 relative h-[600px] md:h-[650px] lg:h-[700px] animate-pulse">
    ...
    return (
      <div className="relative h-[600px] md:h-[650px] lg:h-[700px]">
        ...
        {featuredManga.map((manga, index) => (
          ...
          >
            {/* Thay đổi cách hiển thị ảnh nền */}
