...
const Home = () => {
  ...
  const getHighResolutionCover = (manga) => {
    try {
      ...
      return `https://uploads.mangadex.org/covers/${manga.id}/${coverArt.attributes.fileName}.original.jpg`;
    } catch (error) {
      return '/images/default-cover.jpg';
    }
  };
        ...
        {featuredManga.map((manga, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-cover bg-center bg-no-repeat" style={{ 
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-gray-900 via-gray-800/70 to-transparent"></div>
            </div>
