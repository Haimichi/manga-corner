      ...
      <div className="max-w-6xl mx-auto bg-gray-800 rounded-lg shadow-lg overflow-hidden">
        <div className="md:flex">
          ...
          <div className="md:w-1/3 relative">
            <div 
              className="h-96 md:h-full bg-cover bg-center bg-no-repeat cursor-pointer transition transform hover:brightness-110"
            ...
            <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-gray-900 to-transparent h-32"></div>
          </div>
