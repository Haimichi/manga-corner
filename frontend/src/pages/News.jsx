          ...
          <div className="p-8 md:p-12">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="mb-6 md:mb-0 md:mr-8">
                <h3 className="text-2xl md:text-3xl font-bold text-white mb-2">Nhận tin tức manga mới nhất</h3>
                <p className="text-white text-opacity-90 max-w-md">
                  Đăng ký nhận bản tin để được cập nhật những tin tức, bài viết và sự kiện mới nhất về manga và anime.
                </p>
              </div>
              <div className="w-full md:w-auto">
                <div className="flex flex-col sm:flex-row">
                  <input 
                    ...
                    className="px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-300 mb-2 sm:mb-0 sm:mr-2 w-full"
                  />
                  <button className="bg-white text-primary-700 hover:bg-gray-100 px-6 py-3 rounded-lg font-medium transition-colors">
                    Đăng ký
                  </button>
                </div>
                <p className="text-white text-opacity-70 text-sm mt-2">
                  Chúng tôi không bao giờ gửi spam. Xem <a href="#" className="underline">chính sách bảo mật</a>.
                </p>
              </div>
            </div>
          </div>
              ...
              <div key={item.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                <Link to={`/news/${item.slug}`} className="block">
                  ...
                  <div className="p-4">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 mt-1 hover:text-primary-600 transition-colors line-clamp-2">
                      {item.title}
                    </h3>
                  </div>
                </Link>
